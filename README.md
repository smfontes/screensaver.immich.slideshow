...
10. To only choose pictures from an album, use the album's UUID. This can be found when visiting Immich in your browser, open the album and use the last section of the URL. e.g. https://demo.immich.app/albums/48eb4f94-c847-4118-abf5-70eb3072f27a 
